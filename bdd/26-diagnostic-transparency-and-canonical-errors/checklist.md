...
- [ ] Preserve canonical diagnostic identity across every boundary
- [ ] Sanitize backend failures at the Voiceflow source boundary
- [ ] Redact structured diagnostic DTOs before serialization
- [ ] Present a safe actionable failure without opaque stage-only output
- [ ] Translate layer-specific failures through one canonical diagnostic taxonomy
- [ ] Complete the opaque-error remediation
