...
This checklist is the completion gate for BDD28. Do not mark it complete while any item is unchecked, unverified, or supported only by a source-pattern search.

## Scenario acceptance

- [ ] Use one shared LoguxConnection runner for all supported operations
- [ ] Preserve operation-specific connection policies
- [ ] Preserve the BDD18 wire-frame contract through the shared runner
- [ ] Translate shared transport signals into operation-owned events
- [ ] Settle and clean up a shared connection exactly once
- [ ] Preserve failure identity through shared transport cleanup
- [ ] Keep concurrent Logux operations isolated
- [ ] Complete Logux connection lifecycle consolidation
